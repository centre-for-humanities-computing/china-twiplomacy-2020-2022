...
fake_followers = "/work/cn-some/china-twiplomacy-2020-2022/bot-detection/datasets_full.csv/fake_followers.csv"
genuine_accounts = "/work/cn-some/china-twiplomacy-2020-2022/bot-detection/datasets_full.csv/genuine_accounts.csv"
social_spambots = [f"/work/cn-some/china-twiplomacy-2020-2022/bot-detection/datasets_full.csv/social_spambots_{i+1}.csv" for i in range(3)]
traditional_spambots = [f"/work/cn-some/china-twiplomacy-2020-2022/bot-detection/datasets_full.csv/traditional_spambots_{i+1}.csv" for i in range(4)]
...
outpath = "/work/cn-some/china-twiplomacy-2020-2022/bot-detection/mdl"
pickle.dump(clf, open(f"{outpath}/bot_detect_mdl.sav", 'wb'))
...
info_log.to_csv(f"{outpath}/model_info.csv", index = False)
